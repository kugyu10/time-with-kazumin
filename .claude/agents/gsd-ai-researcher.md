...
<required_reading>
Read `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
