...
Reference full template: `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/templates/state.md`.
