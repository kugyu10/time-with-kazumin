...
- Usage: Reference from command with `@/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
