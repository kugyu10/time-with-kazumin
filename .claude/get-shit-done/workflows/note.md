...
- **Global scope**: `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/notes/`)
...
2. Glob `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/notes/` — works in any directory
