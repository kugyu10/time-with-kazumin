...
```
Task(
  prompt="Read /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/templates/VALIDATION.md`
