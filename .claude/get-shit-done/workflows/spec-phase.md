...
```bash
INIT=$(node "/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/templates/spec.md.
