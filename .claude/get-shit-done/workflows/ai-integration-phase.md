...
<required_reading>
@/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/references/ai-frameworks.md
@/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/kugyu10/work/かずみん/Time-with-Kazumin/.claude/agents/gsd-eval-planner.md for instructions.
