...
- [x] **MEMBER-01**: 会員はGoogle認証またはメール/パスワードでログインできる
- [x] **MEMBER-02**: 会員はメニュー選択してポイント消費で予約できる
- [x] **MEMBER-03**: 会員は現在のポイント残高を確認できる
- [x] **MEMBER-04**: 会員は自分の予約一覧を確認できる
- [x] **MEMBER-05**: 会員は予約をキャンセルしてポイント返還を受けられる
